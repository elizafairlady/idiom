...
#define IDM_OPCODE_LIST(X) \
    ...
    X(MAKE_RECORD, 4, 3, 2, "rcrr", "cT", "drrr", "23", IDM_OPCODE_FLOW_NEXT, IDM_OPCODE_NO_COUNT, IDM_OPCODE_NO_COUNT, 0) \
    X(RECORD_FIELD, 5, IDM_OPCODE_NO_COUNT, 0, "rrccr", "", "dsrrr", "", IDM_OPCODE_FLOW_NEXT, IDM_OPCODE_NO_COUNT, IDM_OPCODE_NO_COUNT, 0) \
    X(RECORD_IS, 3, IDM_OPCODE_NO_COUNT, 0, "rrc", "", "dsr", "", IDM_OPCODE_FLOW_NEXT, IDM_OPCODE_NO_COUNT, IDM_OPCODE_NO_COUNT, 0) \
